...
<div id="app">
    <div id="wrapper">
        <!-- Sidebar -->
        <nav id="sidebar"
             v-show="$router.path==='/'|| $router.path==='/signup'|| $router.path==='forgot'|| $router.path==='/logout'?false:true" style="display: none;"
        >
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <!-- TopBar -->
                                        <nav id="topnavbar"  v-show="$router.path === '/'|| $router.path === '/register'|| $router.path==='/forgot'|| $router.path === '/logout'?false:true" class="navbar navbar-expand navbar-light bg-navbar topbar mb-4 static-top"
                                        style="display: none">
