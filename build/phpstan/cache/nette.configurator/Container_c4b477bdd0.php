...
class Container_c4b477bdd0 extends _PHPStan_a3459023a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService046(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_c4b477bdd0 $container)
			{
	...
	public function createServiceContainer(): Container_c4b477bdd0
	{
		return $this;
	}
