...
class Container_851632b079 extends _PHPStan_a3459023a\Nette\DI\Container
{
	protected $tags = [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'excludePaths' => null,
			'level' => 4,
			'paths' => ['C:\laragon\www\inventory-system\app'],
			'exceptions' => [
				'implicitThrows' => true,
	...
	public function createService046(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_851632b079 $container)
			{
	...
	public function createServiceContainer(): Container_851632b079
	{
		return $this;
	}
