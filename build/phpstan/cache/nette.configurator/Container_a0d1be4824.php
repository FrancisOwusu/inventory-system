...
class Container_a0d1be4824 extends _PHPStan_a3459023a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService046(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_a0d1be4824 $container)
			{
	...
	public function createServiceContainer(): Container_a0d1be4824
	{
		return $this;
	}
