...
class Container_570bd1d835 extends _PHPStan_a3459023a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService046(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_570bd1d835 $container)
			{
	...
	public function createServiceContainer(): Container_570bd1d835
	{
		return $this;
	}
